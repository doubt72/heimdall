...
var LibTree = {
    // Longer names and values than this will be truncated
    // Traverse our JSON object and encode it
    //   branch: JSON data to be encoded (recursively)
    //   rootId: ID of parent, new IDs will be generated for each key/array item
    //   depth: how deep this branch is
    //   links: for attaching links scalars in the true
    //
    ...
    encode: function(branch, rootId, depth, links, options) {
        ...
        // Link object-leaves if configured
        ...
        function listEncode(array, rootId, depth, paths, listId) {
            ...
            for (var item in array) {
                ...
                if (type == "array" || type == "object") {
                    ...
                    if (linkURLs && script == null && looksLikeUrl(value)) {
                        script = {script: 'show-file', args: {}};
                    };
    ...
    drawTree: function(data, svg) {
        ...
        function scrollToOffset(d) {
            ...
            var container = document.getElementById('json-tree-code');
            elem.scrollIntoView();
            container.scrollTop -= 16;
            $('.xcode-selectedx').removeClass('xcode-selectedx');
        ...
        function update(source) {
            ...
            nodes.forEach(function(d) {
                ...
                // d.y = (d.depth * 280); //500px per level.
            });
